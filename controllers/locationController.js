...
const editLocation = async (req,res) =>{
    const { userId,locationId,name, latitude, longitude, experienceType, preference, price, persons, moodBased, timeOfDay,modeOfTransport,recommendation,locationType } = req.body;
        try {
        // console.log("the username is", username)
        ...
        console.log('New location created:', updatedLocation._id);
...
module.exports = { addLocation, getLocations,editLocation }